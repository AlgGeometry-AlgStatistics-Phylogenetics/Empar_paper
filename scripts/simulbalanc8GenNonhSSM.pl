...
print TREEIN "((((((Olithodiscus:", $lbrb,",Euglena:",$lbrb,"):",$lbrb,",Anacystis_nidulans:"
,$lbrb,"):",$lbrb,",Chlorella:",$lbrb,"):",$lbrb,",Chlamydomonas:",$lbrb,"):",$lbrb,",Marchantia:",$lbrb,"):",$lbrb/2,",(Tobacco:", $lbrb,",Rice:", $lbrb,"):",$lbrb/2,");\n";

	    close(TREEIN);
##########################################

#executing GenNonh
	    system('~/GenNon-H/GenNon-h treein.txt ~/ania_k/Empar_paper/data/simul_balanc8GenNonhSSM/length'.$length.'_b'.$tenbrb.'_num'.$i.'.fa '.$length.' ssm >simul.txt')==0 or die "system failed in GenNonh";
#	sleep(1);
