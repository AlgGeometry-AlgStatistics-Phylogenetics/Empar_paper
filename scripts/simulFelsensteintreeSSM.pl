...
#executing GenNonh
	    system('~/GenNon-H/GenNon-h treein.txt ~/ania_k/Empar_paper/data/simul_FelsensteinSSM/length'.$length.'_b'.$tenbrb.'_num'.$i.'.fa '.$length.' ssm >simul.txt')==0 or die "system failed in GenNonh";
#	sleep(1);
