...
#executing GenNonh
	    system('~/GenNon-H/GenNon-h treein.txt ~/ania_k/Empar_paper/data/simul_Felsensteink81/length'.$length.'_b'.$tenbrb.'_num'.$i.'.fa '.$length.' k81 >simul.txt')==0 or die "system failed in GenNonh";
#	sleep(1);
